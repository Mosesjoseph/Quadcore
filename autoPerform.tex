...
\end{itemize}
\subsubsection{Relevant Past Experiences}
Some of my past experiences which I  believe will add value to the project is that I worked on a data processing project at the CSIR during my vacation work. More specifically the processing of Twitter Data to see how gathering  and processing Twitter Data could improve the rate at which Police and other government institutions are able to respond to emergencies and crime because Twitter has real-time updates.
...
\subsubsection{Reasons for wanting to do the project}
I want to work on this project because I love the idea of being better able to measure performance and providing a transparent measure of performance not affected by the bias of people. I think this system will greatly improve the way in which employers manage their employees as well motivate employees to work harder because they will have an understanding of the transparent performance management system. 
\newpage
