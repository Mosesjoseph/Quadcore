...
/**
 * Created by Themba Mbhele on 2016/09/08.
 */
public class ModifyRoute extends AppCompatActivity
{
    Toolbar toolbar;

    private String modify_start, modify_end;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       // Toast.makeText(getApplicationContext(), modify_end, Toast.LENGTH_LONG).show();
        ...
        AutoCompleteTextView autoCompleteTextView = (AutoCompleteTextView)findViewById(R.id.modify_start);
        autoCompleteTextView.setAdapter(new PlacesAutoComplete(this, R.layout.autocomplete_list_item));

        AutoCompleteTextView autoCompleteTextViewEnd = (AutoCompleteTextView)findViewById(R.id.modify_end);
    ...
    {
        //get start location
        EditText start = (EditText)findViewById(R.id.modify_start);
        //get end location
        EditText end = (EditText)findViewById(R.id.modify_end);

        String startParameter = start.getText().toString();
        String endParameter = end.getText().toString();

        //Store user input so that it is accessible on next activity
        //  Intent intent = new Intent(this,DisplayMapActivity.class);

     //   Toast.makeText(getApplicationContext(), startParameter, Toast.LENGTH_LONG).show();
     //   Toast.makeText(getApplicationContext(), endParameter, Toast.LENGTH_LONG).show();
