...
\begin{table}[]
 ...
 \begin{tabular}{ccc}
   \toprule
    ...
    \midrule
    1 & 27 May 2016 & Introduction, Background, Vision, Scope, Use cases & Mpho Baloyi, Hlengekile Jita, Moses Mayimela, Themba Mbhele\\
    2 & 29 July 2016 & Updated Scope, Updated Use Cases, Added Service Contracts, Added Required Functionality, Added Process Specification & Mpho Baloyi, Hlengekile Jita, Moses Mayimela, Themba Mbhele \\
    \bottomrule
  \end{tabular}
\end{table}
\end{comment}
