...
\begin{table}[ht]
 ...
 \begin{tabular}{cccc}
   ...
   \midrule 1 & 27 May 2016 &  & \makecell {Mpho Baloyi,\\ Hlengekile Jita,\\ Moses Mayimela,\\ Themba Mbhele}\\
   2 & 29 July 2016 &  & \makecell {Mpho Baloyi,\\ Hlengekile Jita,\\ Moses Mayimela,\\ Themba Mbhele} \\
   \bottomrule
  \end{tabular}
\end{table}
%\end{comment}
...
\subsubsection{itraffic website}
