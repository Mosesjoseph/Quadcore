...
public class AddRoute extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Button button = (Button)findViewById(R.id.search_button);        button.setTypeface(typeface);
    ...
    public void sendRequestParameters(View view)
    {
        ...
        if(startParameter.isEmpty() || endParameter.isEmpty())
            Toast.makeText(getApplicationContext(), "Enter data in all input fields", Toast.LENGTH_LONG).show();
        else {
            storeData();
            Intent intent = new Intent(this, DisplayMapActivity.class);
            intent.putExtra("start", startParameter);
            intent.putExtra("end", endParameter);
    ...
    public void storeData()
    {
        ...
        Cursor cursor = sqLiteDatabase.rawQuery("SELECT * FROM routes WHERE routeName = '" + nameParameter + " 'startLocation = '"+startParameter+ "' AND endLocation = '"+endParameter+"'", null);
        if(cursor.getCount() < 1)
        {
            ContentValues contentValues = new ContentValues();
            contentValues.put("routeName", nameParameter);
            ...
            Toast.makeText(getApplicationContext(), "Route has already been stored", Toast.LENGTH_LONG).show();
